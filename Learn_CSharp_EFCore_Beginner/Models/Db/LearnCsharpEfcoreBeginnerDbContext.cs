...
public partial class LearnCsharpEfcoreBeginnerDbContext : DbContext
{
    public LearnCsharpEfcoreBeginnerDbContext()
    {
    }

    public LearnCsharpEfcoreBeginnerDbContext(DbContextOptions<LearnCsharpEfcoreBeginnerDbContext> options)
        : base(options)
    {
    }
